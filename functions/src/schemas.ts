...
export const ExerciseMediaSchema = z.object({
  id: z.string(),
  exerciseId: z.string(),
  type: z.enum(["image", "video", "gif", "svg"]),
  url: z.string(),
  source: z.string().optional(),
  variant: z.enum(["male", "female", "neutral"]).optional(),
...
export const ExerciseSchema = z.object({
  exerciseId: z.string().optional().describe("ID from the exercise catalog (preferred)"),
  name: z.string().describe("Exercise name (English)"),
  normalizedId: z.string().optional().describe("Legacy: ID of the matching normalized exercise"),
