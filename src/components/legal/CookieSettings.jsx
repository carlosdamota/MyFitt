 ...
 * @param {object} currentConsent - Consentimiento actual
 * @param {function} onSave - Callback al guardar preferencias
 * @param {function} onClose - Callback al cerrar modal
 */
const CookieSettings = ({ currentConsent, onSave, onClose }) => {
      ...
      <div className="bg-slate-900 border border-slate-700 rounded-2xl p-6 max-w-2xl mx-4 animate-in zoom-in-95 duration-200 shadow-2xl max-h-[90vh] overflow-y-auto">
              ...
              <div className="flex items-start gap-3 flex-1">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-400 leading-relaxed">
                    Necesarias para el funcionamiento básico de la app (autenticación, sesión). No se pueden desactivar.
                  </p>
            ...
            <div className="flex items-start justify-between gap-4">
              <div className="flex items-start gap-3 flex-1">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-400 leading-relaxed">
                    Nos ayudan a entender cómo usas la app para mejorarla. Datos anónimos procesados por Google Analytics.
                  </p>
                  <div className="mt-2 text-xs text-slate-500">
                    <strong>Ejemplos:</strong> Páginas visitadas, tiempo de uso, funciones más usadas
                  </div>
                </div>
              </div>
              <div className="shrink-0">
        ...
        <div className="bg-blue-900/20 border border-blue-500/30 rounded-lg p-3 mb-6">
          <p className="text-xs text-blue-200">
            💡 <strong>Tu privacidad es importante.</strong> Puedes cambiar estas preferencias en cualquier momento desde el footer de la app.
          </p>
        </div>
