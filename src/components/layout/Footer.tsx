...
const Footer: React.FC = () => {
  return (
    <footer className='bg-slate-50 dark:bg-surface-950 border-t border-slate-200 dark:border-surface-900 py-8 px-4 mt-12 pb-24 md:pb-8 transition-colors'>
      <div className='max-w-4xl mx-auto'>
        <div className='flex flex-col md:flex-row justify-between items-center gap-6'>
          {/* Brand & Copyright */}
          <div className='text-center md:text-left'>
            <h3 className='text-lg font-black italic uppercase tracking-tighter text-slate-900 dark:text-white mb-1 transition-colors'>
              FITTWIZ
            </h3>
          ...
          <div className='flex flex-wrap justify-center gap-6'>
            ...
            <Link
              to='/legal'
              className='text-xs text-slate-500 dark:text-slate-400 hover:text-slate-900 dark:hover:text-slate-200 transition-colors flex items-center gap-1.5'
            >
              <Scale size={14} /> Legal
            </Link>
          </div>
        ...
        {/* Disclaimer */}
        <div className='mt-8 pt-6 border-t border-slate-200 dark:border-surface-900 text-center transition-colors'>
