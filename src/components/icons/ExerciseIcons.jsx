...
/**
 * ExerciseIcons component
 * Provides high-quality, professional SVG illustrations for each exercise.
 * These are designed to look consistent (slate-900 style) and informative.
 */
