        ...
        <div className="space-y-8 text-slate-300 leading-relaxed">
          <section>
            <h2 className="text-xl font-bold text-white mb-4 flex items-center gap-2">
              <Building size={20} className="text-blue-400" /> Titular del Sitio Web
            </h2>
            <div className="bg-slate-900 p-6 rounded-xl border border-slate-800 space-y-3">
              <p><span className="text-slate-500 w-32 inline-block">Nombre:</span> FitManual App</p>
              <p><span className="text-slate-500 w-32 inline-block">Contacto:</span> soporte@fitmanual.app</p>
              <p><span className="text-slate-500 w-32 inline-block">Actividad:</span> Aplicación de fitness y salud</p>
            </div>
          </section>
          ...
          <section>
            ...
            <p>
              El presente aviso legal regula el uso del sitio web y aplicación FitManual, que pone a disposición de los usuarios de Internet.
            </p>
          </section>

          <section>
            <h2 className="text-xl font-bold text-white mb-4">2. Propiedad Intelectual e Industrial</h2>
            <p>
              Todos los derechos de propiedad industrial e intelectual de la totalidad de elementos contenidos en esta Web, incluidas las marcas comerciales, formatos, diseños gráficos, textos, imágenes y documentos, pertenecen a FitManual y se encuentran protegidos por las leyes españolas e internacionales sobre propiedad Intelectual e Industrial.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              Esta aplicación está alojada en la infraestructura de Google Cloud Platform (Firebase), cumpliendo con los estándares de seguridad y privacidad requeridos.
            </p>
          </section>
