...
import { Activity, Zap, Shield, BarChart2, ArrowRight, CheckCircle } from 'lucide-react';
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6 py-12 md:py-20 flex flex-col items-center text-center">
        ...
        <div className="mb-16 animate-in fade-in slide-in-from-bottom-8 duration-700">
          ...
          <p className="text-lg md:text-xl text-slate-400 max-w-2xl mx-auto mb-10 leading-relaxed">
            FitManual crea rutinas personalizadas, analiza tu técnica y optimiza tu nutrición usando inteligencia artificial avanzada. Sin configuraciones complejas.
          </p>

          <button 
            onClick={onLogin}
            className="group relative inline-flex items-center gap-3 px-8 py-4 bg-blue-600 hover:bg-blue-500 text-white rounded-2xl font-bold text-lg transition-all hover:scale-105 shadow-xl shadow-blue-900/20"
          >
          ...
          <p className="mt-4 text-sm text-slate-500">No requiere tarjeta de crédito • Privacidad garantizada</p>
        </div>
        ...
        <div className="relative w-full max-w-4xl aspect-video bg-slate-900 rounded-3xl border border-slate-800 shadow-2xl overflow-hidden group">
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <div className="text-center">
              <Activity size={64} className="text-blue-500 mx-auto mb-4 opacity-50 group-hover:opacity-100 group-hover:scale-110 transition-all duration-500" />
